  ...
  ( JNIEnv * env , jobject jobj , jobject cptr , jint stateId )
{
  ...
  {
    tempClass = ( *env )->FindClass( env , "com/xm/luajava/LuaJavaAPI" );
  ...
  {
    tempClass = ( *env )->FindClass( env , "com/xm/luajava/JavaFunction" );
  ...
  (JNIEnv * env , jobject jobj , jobject cptr , jobject obj )
{
   ...
   *userData = globalRef;
   ...
   if ( lua_setmetatable( L , -2 ) == 0 )
   {
      ( *env )->ThrowNew( env , ( *env )->FindClass( env , "com/xm/luajava/LuaException" ) ,
                          "Index is not a java object" );
   }
}
  ...
  (JNIEnv * env , jobject jobj)
{
   ...
   tempClass = ( *env )->FindClass( env , "com/xm/luajava/CPtr" );
